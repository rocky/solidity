...
{
public:
	/// @param _outerFunction the function where the current control-flow is in.
	std::set<VariableDeclaration const*> touchedVariables(ASTNode const& _node, FunctionDefinition const& _outerFunction);
