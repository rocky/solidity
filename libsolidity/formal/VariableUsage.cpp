...
set<VariableDeclaration const*> VariableUsage::touchedVariables(ASTNode const& _node, FunctionDefinition const& _outerFunction)
{
	m_touchedVariables.clear();
	m_functionPath.clear();
	m_functionPath.push_back(&_outerFunction);
	_node.accept(*this);
